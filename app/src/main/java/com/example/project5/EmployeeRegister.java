...
public class EmployeeRegister extends AppCompatActivity implements View.OnClickListener, Dialog.OnCancelListener {

    final int randomNum = 106254; // 테스트할 6자리 인증번호

    private EditText authEmail;                                         //이메일 입력 텍스트
    private Button authBtn;                                             //이메일 인증 버튼
    private boolean validate = false;                                   //중복 검사
    private AlertDialog dialog_id;                                      //중복검사 눌렀을때 뜨는 창
    private EditText et_id;                                             //아이디 입력 텍스트
    private Random rand = new Random();                                 //랜덤난수설정
    private Button sendemailButton;                                     //인증번호 보내기 버튼
    /*Dialog에 관련된 필드*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btn_register = (Button) findViewById(R.id.btn_register); //회원가입 버톤
        authEmail = (EditText) findViewById(R.id.authEmail);        //이메일 작성 텍스트
        authBtn = (Button) findViewById(R.id.authBtn);              //화사이메일 인증 버튼
        final Button validateButton = (Button) findViewById(R.id.validateButton);   //중복검사버튼
        et_id = (EditText) findViewById(R.id.et_id);                //아이디입력
        ...
        sendemailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    gMailSender.sendMail("제목입니다", Integer.toString(rand.nextInt(10)), authEmail.getText().toString());
        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userID.equals(""))
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EmployeeRegister.this);
